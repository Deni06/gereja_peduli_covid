...
<meta charset="utf-8">
    ...
    <title>Add User Group - Gereja Peduli Covid</title>
...
<div id="container" class="effect mainnav-lg">
    ...
    <div class="boxed">
      ...
      <div id="page-content">
                <div class="panel panel-primary"> 
                    ...
                    <form role="form" method="POST" action="<?php echo site_url('admin/user_group/add'); ?>">
                        <div class="row">
                <!-- body items -->
    ...
    <input type="checkbox" name="articles[]" class="form-check-input my-check" id="article1" value="1" onclick="article_checkbox_robot(true)">
      <div class="control__indicator"></div>
    </label>
    <label class="control control--checkbox" style="margin-right: 2%"><i class="input-helper"></i> Add
    <input type="checkbox" name="articles[]" class="form-check-input my-check" id="article2" value="2" onclick="article_checkbox_robot()">
      <div class="control__indicator"></div>
    </label>
    <label class="control control--checkbox" style="margin-right: 2%"><i class="input-helper"></i> Edit
    <input type="checkbox" name="articles[]" class="form-check-input my-check" id="article3" value="3" onclick="article_checkbox_robot()">
      <div class="control__indicator"></div>
    </label>
    <label class="control control--checkbox" style="margin-right: 2%"><i class="input-helper"></i> Delete
    <input type="checkbox" name="articles[]" class="form-check-input my-check" id="article4" value="4" onclick="article_checkbox_robot()">
      <div class="control__indicator"></div>
    </label>
    <label class="control control--checkbox"><i class="input-helper"></i> Review
    <input type="checkbox" name="articles[]" class="form-check-input my-check" id="article5" value="5" onclick="article_checkbox_robot()">
      <div class="control__indicator"></div>
    </label>
    </div>
	</div> 
    ...
    <input type="checkbox" name="user_groups[]" class="form-check-input my-check" id="user_group4" value="4" onclick="user_group_checkbox_robot()">
      <div class="control__indicator"></div>
        ...
        <div class="form-group">    
    <label class="control control--checkbox" style="margin-right: 2%"><i class="input-helper"></i> View
    <input type="checkbox" name="donations[]" class="form-check-input my-check" id="donasi1" value="1" onclick="donasi_checkbox_robot(true)">
      <div class="control__indicator"></div>
    </label>    
    <label class="control control--checkbox" style="margin-right: 2%"><i class="input-helper"></i> Edit
    <input type="checkbox" name="donations[]" class="form-check-input my-check" id="donasi2" value="2" onclick="donasi_checkbox_robot()">
      <div class="control__indicator"></div>
    </label>   
    </div>
	</div>	  
        ...
        <div class="form-group">    
    <label class="control control--checkbox" style="margin-right: 2%"><i class="input-helper"></i> View
    <input type="checkbox" name="contacts[]" class="form-check-input my-check" id="contact1" value="1" onclick="kontak_kami_checkbox_robot(true)">
      <div class="control__indicator"></div>
    </label>    
    <label class="control control--checkbox" style="margin-right: 2%"><i class="input-helper"></i> Edit
    <input type="checkbox" name="contacts[]" class="form-check-input my-check" id="contact2" value="2" onclick="kontak_kami_checkbox_robot()">
      <div class="control__indicator"></div>
    </label>    
    </div>
	</div>	  
        ...
        <div class="form-group">    
    <label class="control control--checkbox" style="margin-right: 2%"><i class="input-helper"></i> View
    <input type="checkbox" name="ads[]" class="form-check-input my-check" id="ads1" value="1" onclick="ads_checkbox_robot(true)">
      <div class="control__indicator"></div>
    </label>
    <label class="control control--checkbox" style="margin-right: 2%"><i class="input-helper"></i> Add
    <input type="checkbox" name="ads[]" class="form-check-input my-check" id="ads2" value="2" onclick="ads_checkbox_robot()">
      <div class="control__indicator"></div>
    </label>
    <label class="control control--checkbox" style="margin-right: 2%"><i class="input-helper"></i> Edit
    <input type="checkbox" name="ads[]" class="form-check-input my-check" id="ads3" value="3" onclick="ads_checkbox_robot()">
      <div class="control__indicator"></div>
    </label>
    <label class="control control--checkbox"><i class="input-helper"></i> Delete
    <input type="checkbox" name="ads[]" class="form-check-input my-check" id="ads4" value="4" onclick="ads_checkbox_robot()">
      <div class="control__indicator"></div>
    </label>
    </div>
	</div>	                                                                 
