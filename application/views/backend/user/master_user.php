...
<head>
    ...
    <title>Master User - Gereja Peduli Covid</title>
                            ...
                            <tr style="background: #455a64; color:white">                         
                             ...
                             <?php                                     
                                ...
                                <td><?php echo $u['usr_fullname']; ?></td>
		                            ...
		                            <td><?php echo $u['usr_city']; ?></td>
		                            <td><?php echo $u['usr_zip']; ?></td>
		                            <td><?php echo $u['usr_name']; ?></td>
                                      <td><a onclick='View_user("<?=$u['usr_id']?>")' class="btn btn-info btn-anim btn-large" style="color:#fff !important;"><i class="fa fa-eye font-size-11 pt-8-im"></i></a></td>
                                        <td>
                                        <?php    
                if($edit_access !== false){
                ?>
            <a onclick="location.href='<?=site_url('admin/user/edit/'.$u['usr_id'])?>'" class="btn btn-primary btn-anim btn-large" style="color:#fff !important;"><i class="fa fa-pencil font-size-11 pt-8-im"></i></a>
                <?php } ?>              
                                        </td>
                                        <td>
                                        <?php    
                ...
                ?>
            <a onclick='delete_item("<?=$u['usr_id']?>")' class="btn btn-danger btn-anim btn-large" style="color:#fff !important;"><i class="fa fa-trash font-size-11 pt-8-im"></i></a>
                <?php } ?>                                                      
                                        </td>                               
                                    </tr>
