...
<meta charset="utf-8">
    ...
    <title>Add User - Gereja Peduli Covid</title>
                        ...
                        <div class="panel-body">
                          ...
                          ?>
                            ...
                            <div class="form-group" style="margin-bottom:3%;">
                                ...
                                <input type="email" name="usr_name" placeholder="User Email" value="<?php echo $this->input->post('usr_name'); ?>" class="form-control" id="usr_name" required/>
                                </div>  
                                ...
                                <input type="tel" name="usr_phone" value="<?php echo $this->input->post('usr_phone'); ?>" class="form-control" onkeypress='return isNumberKey(event)' id="usr_phone" required/>
                                </div>  

                                <div class="form-group" style="margin-bottom:3%;">
                                <label for="city"><b>City</b></label>
                                <input type="text" name="usr_city" placeholder="User City" value="<?php echo $this->input->post('usr_city'); ?>" class="form-control" id="usr_city" required/>
                                </div>  

                                <div class="form-group" style="margin-bottom:3%;">
                                <label for="zip_code"><b>Zip Code</b></label>
                                <input type="text" name="usr_zip" placeholder="User Zip Code" value="<?php echo $this->input->post('usr_zip'); ?>" class="form-control" id="usr_zip" />
                                </div>  

                                <div class="form-group" style="margin-bottom:3%;">
                                <label for="city_code"><b>City Code</b></label>
                                <input type="text" name="usr_citycode" placeholder="User City Code" value="<?php echo $this->input->post('usr_citycode'); ?>" class="form-control" id="usr_citycode" />
                                </div>  
