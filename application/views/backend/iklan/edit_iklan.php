...
<meta charset="utf-8">
    ...
    <title>Edit Iklan - Gereja Digital</title>
      ...
      <div id="page-content">
                <div class="panel panel-primary"> 
                    <div class="panel-heading" style="background: #455a64">
                        <h3 class="panel-title"><b>Edit Iklan</b></h3>
                    </div>
                    <div class="panel-body">
                    <form role="form" method="POST" action="<?php echo site_url('admin/iklan/edit/'.$iklan->row()->ads_id); ?>" onsubmit="return submitform()" enctype="multipart/form-data">
                        <div class="row">
                <!-- body items -->
                ...
                <div class="col-md-12">
                        ...
                        <div class="panel-body">
                          ...
                          ?>
                            ...
                            <div class="form-group" style="margin-bottom:3%;">
                                ...
                                <select class="form-control" id="posisi_iklan" name="posisi_iklan" required>
                                  <?php $value = ($this->input->post('posisi_iklan') ? $this->input->post('posisi_iklan') : $iklan->row()->ads_position);
                  $displayHome = "show";
                  $displayBerita = "show";
                  $displayArtikel = "show";
                  ...
                  if($iklan != FALSE) {
                    foreach($iklan as $i){
                      if($i->ads_position == 1 && $i->ads_position != $iklan->row()->ads_position){
                        $displayHome = "";
                      }
                      if($i->ads_position == 2 && $i->ads_position != $iklan->row()->ads_position){
                        $displayBerita = "";
                      }
                      if($i->ads_position == 3 && $i->ads_position != $iklan->row()->ads_position){
                        $displayArtikel = "";
                      }
                      if($i->ads_position == 4 && $i->ads_position != $iklan->row()->ads_position){
                        $displaySerbaSerbi = "";
                      }
                    }
                  }
                  ...
                  <?php } ?>                                                                     
                                ...
                                <div class="form-group" style="margin-bottom:5%;" id="image_upload">
                                  ...
                                  getImageDetail("<?=base_url().'assets/images/ads/'.$iklan->row()->url?>","logo-upload-image", "logo-upload-content", "logo-title", "logo-upload-wrap","<?=base_url().'assets/images/ads/'?>", "logo-upload-input");                
