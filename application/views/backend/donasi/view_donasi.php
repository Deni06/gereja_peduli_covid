...
<head>
  ...
  <title>View Donasi - Gereja Peduli Covid</title> 
...
<body>
  <div id="container" class="effect mainnav-lg">
    ...
    $donasi_access = $this->user_library->show_donasi_access();
                        if($donasi_access != null && $donasi_access != ""){                                                                        
                $edit_access = strpos($donasi_access, ';2;');                
                        }
    ?>
    <!--===================================================-->
    <!--END NAVBAR-->
      ...
      <div id="content-container">
        ...
        <div id="page-content">
          <div class="panel panel-primary"> 
            ...
            <a href="<?=site_url('admin/donasi/edit/')?>" name="submit" style="background: #455a64; color:white;font-family:montserrat; float: right;" class="btn">EDIT <i class="fa fa-pencil" style="margin-left: 3%;"></i></a>
                <?php } ?>                
              </div>
                <div class="panel-body">                                    
                <?php echo $donasi->description;?>
                </div>
              </div>
