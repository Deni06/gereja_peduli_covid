...
<meta charset="utf-8">
    ...
    <title>Edit Donasi - Gereja Peduli Covid</title>
      ...
      <div id="page-content">
                <div class="panel panel-primary"> 
                    <div class="panel-heading" style="background: #455a64">
                        <h3 class="panel-title"><b>Edit Donasi</b></h3>
                    </div>
                    <div class="panel-body">
                    <form role="form" method="POST" action="<?php echo site_url('admin/Donasi/doedit'); ?>" onsubmit="return submitform()">
                        <div class="row">
                <!-- body items -->
                        ...
                        <div class="panel-body">
                          ...
                          ?>
                            ...
                            <div class="form-group" style="margin-bottom:3%;">                                
                                ...
                                <div class="form-group" style="margin-bottom:3%;">
                                <label for="name"><b>Description Donasi</b></label>                                
                                <textarea class="form-control" name="description" id="description" placeholder="Description Donasi" required><?php echo $donasi->description;?></textarea>                                
                                </div>                                                                                                   
                                </div>                                 
                                <button type="submit" onsubmit="submitform()" name="submit" style="background: #455a64; color:white;font-family:montserrat; margin-right: 20px" class="btn col-md-5">  SAVE  <i class="fa fa-save" ></i></button>
                                        <a style="border: 2px solid #455a64;font-family:montserrat" class="btn col-md-5" onclick="location.href='<?=site_url('admin/donasi/')?>'">  CANCEL  <i class="fa fa-ban"></i></a>
                            </div>
