		...
		<div class="section top-header" style="padding-bottom: 20px;padding-top: 20px;">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div>
							<h1 style="text-align: center;"><?=$organization->row()->organization_name?></h1>
							<?=$organization->row()->description?>
						</div>						
						<hr>
						<div class="contact" style="margin-bottom: 10px;">
							<h3 style="margin-bottom: 0">Kontak Kami</h3>
							<h4 style="margin-top: 17px;"><?=$organization->row()->organization_name?></h4>
							<div>
								<?php foreach($organization_address as $row){ ?>
									<h5 style="font-weight: normal;"><?=$row->address?></h5>							
									<?php } ?>							
							</div>						
							<div style="margin-bottom: 5px;">
								<i class="fa fa-phone" style="margin-right: 0.5%;"></i>								
								<a href="tel:<?=$organization->row()->phone_number?>" style="font-weight: normal;color: blue;margin-bottom: 0;"><u><?=$organization->row()->phone_number?></u></a>
							</div>							
							<div>								
									<i class="fa fa-envelope" style="margin-right: 0.5%"></i>
									<a href="mailto:<?=$organization->row()->email?>" style="font-weight: normal;color: blue;margin-bottom: 0;"><u><?=$organization->row()->email?></u></a>
							</div>	
						</div>
					</div>					
					<!-- /Main Column -->					
